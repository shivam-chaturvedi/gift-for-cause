...
const Signup = () => {
  ...
  const [role, setRole] = useState<"donor" | "ngo">("donor"); // default donor
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await signup(email, password, name, role); // pass role to signup
      toast({
    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Sign up to start making impact</p>
        </div>
